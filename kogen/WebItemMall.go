...
func (this *WebItemMall) GetTableName() string {
	return _WebItemMallTableName
}

// GetInsertString Returns the insert statement for the table populated with record from the object
func (this *WebItemMall) GetInsertString() string {
	return fmt.Sprintf("INSERT INTO [WEB_ITEMMALL] (strAccountID, strCharID, ServerNo, ItemID, ItemCount, BuyTime, img_file_name, strItemName, price, pay_type) \nVALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", GetOptionalBinaryVal(this.AccountId),
