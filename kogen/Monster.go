...
type Monster struct {
	...
	Name                *mssql.VarChar `gorm:"column:strName;type:varchar(30)" json:"strName,omitempty"`
...
func (this Monster) GetInsertData() string {
	return fmt.Sprintf("(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", GetOptionalDecVal(&this.MonsterId),
		GetOptionalVarCharVal(this.Name, false),
		GetOptionalDecVal(&this.PictureId),
		GetOptionalDecVal(&this.Size),
		GetOptionalDecVal(&this.Weapon1),
...
func (this Monster) SelectClause() (selectClause clause.Select) {
	return _MonsterSelectClause
}

// GetAllTableData Returns a list of all table data
func (this Monster) GetAllTableData(db *gorm.DB) (results []Model, err error) {
	res := []Monster{}
	rawSql := "SELECT [sSid], [strName], [sPid], [sSize], [iWeapon1], [iWeapon2], [byGroup], [byActType], [byType], [byFamily], [byRank], [byTitle], [iSellingGroup], [sLevel], [iExp], [iLoyalty], [iHpPoint], [sMpPoint], [sAtk], [sAc], [sHitRate], [sEvadeRate], [sDamage], [sAttackDelay], [bySpeed1], [bySpeed2], [sStandtime], [iMagic1], [iMagic2], [iMagic3], [sFireR], [sColdR], [sLightningR], [sMagicR], [sDiseaseR], [sPoisonR], [sLightR], [sBulk], [byAttackRange], [bySearchRange], [byTracingRange], [iMoney], [sItem], [byDirectAttack], [byMagicAttack], [byMoneyType] FROM [K_MONSTER]"
...
var _MonsterSelectClause = clause.Select{
