...
type UserSavedMagic struct {
	CharId   [50]byte `gorm:"column:strCharID;type:varchar(50);primaryKey;not null" json:"strCharID"`
...
func (this *UserSavedMagic) GetTableName() string {
	return _UserSavedMagicTableName
}

// GetInsertString Returns the insert statement for the table populated with record from the object
func (this *UserSavedMagic) GetInsertString() string {
	return fmt.Sprintf("INSERT INTO [USER_SAVED_MAGIC] (strCharID, nSkill1, nDuring1, nSkill2, nDuring2, nSkill3, nDuring3, nSkill4, nDuring4, nSkill5, nDuring5, nSkill6, nDuring6, nSkill7, nDuring7, nSkill8, nDuring8, nSkill9, nDuring9, nSkill10, nDuring10) \nVALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", GetOptionalBinaryVal(this.CharId),
