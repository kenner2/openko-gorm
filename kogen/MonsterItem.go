...
type MonsterItem struct {
	MonsterId   int16  `gorm:"column:sIndex;type:smallint;not null" json:"sIndex"`
...
func (this *MonsterItem) GetDatabaseName() string {
	return GetDatabaseName(DbType(_MonsterItemDatabaseNbr))
}

// GetTableName Returns the table name
func (this *MonsterItem) GetTableName() string {
	return _MonsterItemTableName
}

// GetInsertString Returns the insert statement for the table populated with record from the object
func (this *MonsterItem) GetInsertString() string {
	return fmt.Sprintf("INSERT INTO [K_MONSTER_ITEM] (sIndex, iItem01, sPersent01, iItem02, sPersent02, iItem03, sPersent03, iItem04, sPersent04, iItem05, sPersent05) \nVALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", GetOptionalDecVal(&this.MonsterId),
