...
func (this *RentalItemList) GetTableName() string {
	return _RentalItemListTableName
}

// GetInsertString Returns the insert statement for the table populated with record from the object
func (this *RentalItemList) GetInsertString() string {
	return fmt.Sprintf("INSERT INTO [RENTAL_ITEM_LIST] (nRentalIndex, nItemIndex, sDurability, nSerialNumber, byRegType, byItemType, byClass, sRentalTime, nRentalMoney, strLenderCharID, strLenderAcID, strBorrowerCharID, strBorrowerAcID, timeLender, timeRegister) \nVALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", GetOptionalDecVal(&this.RentalIndex),
