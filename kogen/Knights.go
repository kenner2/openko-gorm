...
type Knights struct {
	...
	Name            mssql.VarChar  `gorm:"column:IDName;type:varchar(21) COLLATE SQL_Latin1_General_CP1_CI_AS;not null" json:"IDName"`
	Members         int16          `gorm:"column:Members;type:smallint;not null;default:1" json:"Members"`
	Chief           mssql.VarChar  `gorm:"column:Chief;type:varchar(21) COLLATE SQL_Latin1_General_CP1_CI_AS;not null" json:"Chief"`
	ViceChief1      *mssql.VarChar `gorm:"column:ViceChief_1;type:varchar(21) COLLATE SQL_Latin1_General_CP1_CI_AS" json:"ViceChief_1,omitempty"`
	ViceChief2      *mssql.VarChar `gorm:"column:ViceChief_2;type:varchar(21) COLLATE SQL_Latin1_General_CP1_CI_AS" json:"ViceChief_2,omitempty"`
	ViceChief3      *mssql.VarChar `gorm:"column:ViceChief_3;type:varchar(21) COLLATE SQL_Latin1_General_CP1_CI_AS" json:"ViceChief_3,omitempty"`
	EnemyName       *mssql.VarChar `gorm:"column:strEnemyName;type:varchar(21) COLLATE SQL_Latin1_General_CP1_CI_AS" json:"strEnemyName,omitempty"`
	...
	Stash           *mssql.VarChar `gorm:"column:Stash;type:varchar(1600) COLLATE SQL_Latin1_General_CP1_CI_AS" json:"Stash,omitempty"`
