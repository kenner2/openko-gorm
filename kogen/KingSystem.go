...
type KingSystem struct {
	...
	KingName          *mssql.VarChar `gorm:"column:strKingName;type:varchar(21)" json:"strKingName,omitempty"`
	ImRequestId       *mssql.VarChar `gorm:"column:strImRequestID;type:varchar(21)" json:"strImRequestID,omitempty"`
}
