...
type UserData struct {
	...
	SkillData      *mssql.VarChar `gorm:"column:strSkill;type:varchar(10) COLLATE SQL_Latin1_General_CP1_CI_AS;default:0x00" json:"strSkill,omitempty"`
	ItemData       *mssql.VarChar `gorm:"column:strItem;type:varchar(400) COLLATE SQL_Latin1_General_CP1_CI_AS" json:"strItem,omitempty"`
	Serial         *mssql.VarChar `gorm:"column:strSerial;type:varchar(400) COLLATE SQL_Latin1_General_CP1_CI_AS" json:"strSerial,omitempty"`
	QuestCount     int16          `gorm:"column:sQuestCount;type:smallint;not null;default:0" json:"sQuestCount"`
	QuestData      *mssql.VarChar `gorm:"column:strQuest;type:varchar(400) COLLATE SQL_Latin1_General_CP1_CI_AS" json:"strQuest,omitempty"`
